...
struct NormalTriangle
{
	...
	NormalTriangle(
		const FVF_PositionNormal& v1, 
		const FVF_PositionNormal& v2, 
		const FVF_PositionNormal& v3)
	{
		vertex[0] = v1;
		vertex[1] = v2;
		vertex[2] = v3;
...
struct TextureNormalTriangle
{
	...
	TextureNormalTriangle(
		const FVF_PositionNormalTexture& v1, 
		const FVF_PositionNormalTexture& v2, 
		const FVF_PositionNormalTexture& v3)
	{
		vertex[0] = v1;
		vertex[1] = v2;
		vertex[2] = v3;
